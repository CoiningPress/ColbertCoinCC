...
uint256 hashGenesisBlock("0x00000000dd044fc13d2aea9faa0cdfd6963eecec63a7f26e882393304682d750");
...
const string strMessageMagic = "ColbertCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000dd044fc13d2aea9faa0cdfd6963eecec63a7f26e882393304682d750");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1396953571;
        block.nBits    = 486604799;
        block.nNonce   = 3334335944;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ColbertCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ColbertCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ColbertCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running ColbertCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ColbertCoinMiner terminated\n");
        throw;
    }
}
